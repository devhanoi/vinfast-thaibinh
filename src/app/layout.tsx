...
export const metadata: Metadata = {
  ...
  title: {
    default: `${SITE.name} | Đại lý 3S chính hãng – ${SITE.hotline}`,
    template: `%s | ${SITE.name}`,
  },
  description: `Đại lý VinFast Thái Bình 3S chính hãng tại Đại Lộ Kỳ Đồng – báo giá VF3, VF5, VF6, VF7, VF8, VF9, trả góp 80%, lái thử miễn phí. Hotline ${SITE.hotline}.`,
  ...
  openGraph: {
    ...
    url: SITE.url,
    siteName: SITE.name,
    title: `${SITE.name} | Đại lý 3S chính hãng – Báo giá tháng mới nhất`,
    description: `Showroom VinFast 3S tại TP. Thái Bình – báo giá VF3, VF5, VF6, VF7, VF8, VF9, trả góp 80%, lái thử miễn phí. Gọi ${SITE.hotline}.`,
    locale: "vi_VN",
    images: [{ url: "/images/og-cover.jpg", width: 1200, height: 630, alt: `Showroom ${SITE.name}` }],
  },
  twitter: {
    card: "summary_large_image",
    title: `${SITE.name} | Đại lý 3S chính hãng`,
